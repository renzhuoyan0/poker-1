window.onload=function(){
    ...
    var fn=function(){
        ...
        for(var i=0;i<7;i++){
            for(var j=0;j<i+1;j++){
                ...
                block.style.left=(6-i)*170/2+j*170+'px';
        ...
        blockc.style.backgroundImage='url(./images/u=3380131298,4095788908&fm=21&gp=0.jpg)';
    ...
    for(var i=0;i<els.length;i++){
        ...
        els[i].style.backgroundImage='url(./images/1/'+pokerp+'.jpg)';
    }
